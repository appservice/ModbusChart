...
.controller('ChartOnlineController', [ '$scope', function($scope) 	{
		$scope.someData = [ ];
			...
			if(k<10){
				...
				if(i<10){
					$scope.someData.push(
						{"column-1":Math.random()*2+Math.cos(i/12)*15+5,
						"column-2":Math.random()*2+10-i*0.3,
						"date":"2014-03-02 0"+k+":0"+i+":00"});
						}
					else{		
