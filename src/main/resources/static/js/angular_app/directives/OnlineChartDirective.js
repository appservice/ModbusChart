...
.directive('onlineChart', function($window, Restangular) {
	return {
		restrict : 'E',
		scope : { // Isolate scope
			data : '=',
		...
		link : function(scope, element, attrs) {
			...
			/**
			 * ===================================================================================
			 * watchCollection event -is executing when data collection is
			 * changed
			 * ===================================================================================
			 */
			scope.$watchCollection("data", function(newData, oldData) {
				...
				if (newData != oldData) {
					...
					/*
					 * if (firstData == null) { firstData = newData; }
					 */
